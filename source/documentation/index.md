...
|              Various APIs              |                      N/A                      |                           N/A                           | **Tax Year Specific (TYS) APIs**<br/> Movement of the old APIs to new tax year specific APIs which means that software providers and user will need to use the new version of the APIs to report data from 23/24.                                                                                                                                                                                                                                                               | Split deliveries  Nov 2022/Jan 2023 |
...
|     Individuals Charges (MTD) API v1.0     |                      N/A                      |                           N/A                           | **Pension charges API – correction**<br/>  3 data items - annual allowance reduced, tapered annual allowances and money purchase allowance are incorrectly sitting under the pension tax saving charges section in this API and need to be moved to the pension contributions section that sits in the same API                                                                                                                                                                                                                                                                                                                                                                      |        March 2023       |
