...
| Business Income Source Summary (MTD) API v2.0 and Property Business (MTD) API v2.0 | No | Yes | **Basis Period Reform**<br/> **Customer election for month end ‘calendar quarters’** Customers must elect or withdraw election before any updates have been submitted for the tax year. This will be a new endpoint that all software products must support for all MTD customers |
...
| Individual Losses (MTD) API v3.0 | No | Yes | **Claim outside of the amendment window** Enables amendments to be made outside the amendment window | 
