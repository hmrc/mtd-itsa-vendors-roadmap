...
| [Individual Calculations](https://developer.service.hmrc.gov.uk/api-documentation/docs/api/service/individual-calculations-api/) (V8),<br>[CIS Deductions](https://developer.service.hmrc.gov.uk/api-documentation/docs/api/service/cis-deductions-api/) (V2) 	| Validation Failure on Contractor Name 	| No 	| 23/24+ 	| Yes 	| Yes 	| September 2025 (deployed)	|
...
| [Individual Calculations](https://developer.service.hmrc.gov.uk/api-documentation/docs/api/service/individual-calculations-api) v6.0| Scottish Rate<br/> Add a new enum value within tax bands field to accommodate the Scottish Advanced Rate. | Yes | 24&#8209;25+ | No | Yes | September 2024 |
...
| Property Business v3.0,<br/> Self-Employment Business v3.0,<br/> Business Details (V1)  | **Basis period reform**<br/> Customer choice of calendar quarterly period dates. Customers must choose before any updates have been submitted for the tax year. This will be a new endpoint that all software products can support for all MTD customers.                                                                                                                                                                                                             | No                                            | Yes             | Jan 2024                 |
...
| Business Details (V1),<br/>Individual Calculations v5.0 | **Retrieve multiple SE sources** <br/> Ability to view multiple business/property sources that are added outside of software. | No | Yes | Aug 2023 |
