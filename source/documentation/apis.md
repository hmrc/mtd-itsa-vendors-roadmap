...
| [Business Details](https://developer.service.hmrc.gov.uk/api-documentation/docs/api/service/business-details-api/) (V2)	| **Capture and change accounting method** – ability for a user to submit their accounting method (Cash or Accruals) and make amendments to it at the end of the year, following this change we will also be removing the data item accounting type from the business details API. 	| No 	| 25/26+ 	| No 	| No 	| June 2025 (deployed)	|
| [Business Details](https://developer.service.hmrc.gov.uk/api-documentation/docs/api/service/business-details-api/) (V2) 	| **Capturing Period of Account** – ability for the user to submit their period of account at the end of the year 	| No 	| TBC  	|  TBC 	| TBC | June 2025 (deployed)	|
