...
| [Business Details](https://developer.service.hmrc.gov.uk/api-documentation/docs/api/service/business-details-api/) (V2) 	| **Capturing Period of Account** – ability for the user to submit their period of account at the end of the year 	| No 	| TBC  	|  TBC 	| No | June 2025 (deployed)	|
