...
| --- | --- | --- | --- | --- | --- | --- |
| [Individuals Employments Income](https://developer.service.hmrc.gov.uk/api-documentation/docs/api/service/individuals-employments-income-api/2.0) (V2)  | Student Loan BIK – a change to ensure the payrolled BIK are excluded from student loan calculations | No  | 25-26+ | Yes | Yes  | September 2025 (deployed) |
| [Individual Relief Api](https://developer.service.hmrc.gov.uk/api-documentation/docs/api/service/individuals-reliefs-api/3.0) (V3) | Withdrawal of social investment tax relief (SITR)  <br>Removal of SITR data items. | Yes | 25-26+ | No  | No  | September 2025 (deployed) |
| [Business Details (MTD)](https://developer.service.hmrc.gov.uk/api-documentation/docs/api/service/business-details-api/1.0) (V2) | Basis Period Reform – ability to review and disapply Late Accounting Date Rules. | No  | 25/26 + | Yes | Yes | September 2025 (deployed) |
