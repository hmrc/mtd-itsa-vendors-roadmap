...
| --- | --- | --- | --- | --- | --- | --- |
| [Individuals Employments Income](https://developer.service.hmrc.gov.uk/api-documentation/docs/api/service/individuals-employments-income-api/) (V2)  | Student Loan BIK – a change to ensure the payrolled BIK are excluded from student loan calculations | No  | 25-26+ | Yes | Yes  | September 2025 (deployed) |
...
| [Business Details (MTD)](https://developer.service.hmrc.gov.uk/api-documentation/docs/api/service/business-details-api/) (V2) | Basis Period Reform – ability to review and disapply Late Accounting Date Rules. | No  | 25/26 + | Yes | Yes | September 2025 (deployed) |
| [Individual Calculations](https://developer.service.hmrc.gov.uk/api-documentation/docs/api/service/individual-calculations-api/) (V8),<br>[CIS Deductions](https://developer.service.hmrc.gov.uk/api-documentation/docs/api/service/cis-deductions-api/) (V3) 	| Validation Failure on Contractor Name 	| No 	| 23/24+ 	| Yes 	| Yes 	| September 2025 (deployed)	|
| [Self Assessment Accounts](https://developer.service.hmrc.gov.uk/api-documentation/docs/api/service/self-assessment-accounts-api/) (V4) | A new field named `codedOutStatus` was added to expose additional financial status data 	| No 	| Non-TYS 	| No 	| Yes 	| September 2025 (deployed) 	|
...
| [Individual Calculations](https://developer.service.hmrc.gov.uk/api-documentation/docs/api/service/individual-calculations-api/)<br> | Capital Gains Tax – 2 additional data items (claim or election codes, and Rtt Tax Paid) to be added to the 'Create and amend other capital gains and disposals' endpoint | Yes | 25-26+ | No  | No  | October 2025 |
...
|     | Guidance only product to allow software to provide an SA302 output | N/A | 25-26+ | N/A | N/A | December 2025 |
...
| Individual State Benefits  	| New business validation rule to reject state benefit submissions where `taxPaid` is populated in the request body and the benefit type (held on ISS) is one of  `statePension`, `bereavementAllowance` or `otherStateBenefits`. 	| Yes 	| 25/25+ 	| No 	| Yes 	| December 2025 	|
...
| [Business Details (MTD)](https://developer.service.hmrc.gov.uk/api-documentation/docs/api/service/business-details-api/)<br><br>(V2) | Capture and change accounting method – ability for a user to submit their accounting method (Cash or Accruals) and make amendments to it at the end of the year, following this change we will also be removing the data item accounting type will be removed from business details API. | No  | 25/26+ | No  | Yes | June 2025 |
| [Business Details (MTD)](https://developer.service.hmrc.gov.uk/api-documentation/docs/api/service/business-details-api/)<br><br>(V2) | Capturing Period of Account – ability for the user to submit their period of account at the end of the year | No  | 25-26+ | Yes | Yes | September 2025 |
| [Business Details (MTD)](https://developer.service.hmrc.gov.uk/api-documentation/docs/api/service/business-details-api/)<br><br>(V2) | Non-Aligned Tax payers – this will ensure that users have the ability to report their taxable profits if their period of account is not aligned. | No  | 25-26 but its an end to end process | No  | Yes | June 2025 |
