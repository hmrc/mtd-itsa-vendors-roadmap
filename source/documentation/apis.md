...
|---	|---	|---	|---	|---	|---	|---	|
| [Individual Calculations](https://developer.service.hmrc.gov.uk/api-documentation/docs/api/service/individual-calculations-api/) (V7 & V8),<br>[Individuals Charges](https://developer.service.hmrc.gov.uk/api-documentation/docs/api/service/individual-charges-api/) (V3) 	| **High Income Child Benefit** - enable self-employed customers with income over £60k to record a HICB liability, so the liability can be included in their tax calculation. 	| No 	| 25-26+ 	| No 	| No 	| June 2025 (deployed)	|
| [Business Details](https://developer.service.hmrc.gov.uk/api-documentation/docs/api/service/business-details-api/) 	| **Capture and change accounting method** – ability for a user to submit their accounting method (Cash or Accruals) and make amendments to it at the end of the year, following this change we will also be removing the data item accounting type will be removed from business details API. 	| No 	| 25/26+ 	| No 	| Yes 	| June 2025 (deployed)	|
| [Business Details](https://developer.service.hmrc.gov.uk/api-documentation/docs/api/service/business-details-api/)  	| **Capturing Period of Account** – ability for the user to submit their period of account at the end of the year 	| No 	| TBC  	|  TBC 	| TBC | September 2025 	|
...
| [Individual Calculations](https://developer.service.hmrc.gov.uk/api-documentation/docs/api/service/individual-calculations-api/) 	| **Negative value** – update to ensure the individual calculations API can retrieve negative values for the data item "Total Income Tax and Nics due" field. 	| No 	| 25-26+ 	| TBC	| TBC | June 2025 	|
...
| Individual Capital Gains Income API, Individuals Calculations API 	| **Capital Gains Tax** – new additions being added to the CGT journey to include Unlisted Shares and Securities Losses and Adjustments - Business Asset Disposal Relief (BADR) Qualifying Asset Holding Company (QAHC) -  	| Yes 	| 25/26+ 	| No 	| No 	| September 2025 	|
| Individual Capital Gains Income API 	| **Capital Gains Tax** – two additional data items (claim or election codes and Rtt Tax Paid) to be added to create and amend other capital gains and disposals 	| Yes 	| 25/26+ 	| No 	| No 	| September 2025 	|
| Property API 	| **Foreign Property** – changes required to enhance the journey for multiple foreign properties in the same country. 	| TBC 	| TBC 	| Yes 	| TBC 	| September 2025 	|
...
| API(s) 	| Change 	| [Breaking?](#def_br) 	| [Tax years](#def_ty) 	| [Affects quarterly updates?](#def_aqu)	| [Usable in year?](#def_uiy)	| [Deploy to Sandbox](#def_dep)	|
|---	|---	|---	|---	|---	|---	|---	|
| Obligations 	| **Align quarterly deadlines** – to bring the due date of quarterly updates in line with VAT – 7th of each month 	| No 	| 26/27 + 	| Yes 	| No 	| December 2025 	|
| Individual Calculations 	| **ITSA status** – renaming of non-digital status to Digitally Exempt  	| TBC  	| 25-26+  	| No  	|  Yes 	| December 2025  	|
| Property Business 	| **Reassert number of rental properties** - expand the property income submission API to allow a customer to reassert their number of rental properties and if they jointly let any of their rental properties for each tax year. 	| TBC 	| TBC 	| TBC 	| TBC 	| December 2025 	|
|  	| **Mortgage evidence** - the ability for a customer to access evidence to support their mortgage application. 	| TBC 	| TBC 	| Yes 	| TBC 	| December 2025 	|
|  	| **Calendar quarter enhancement** – to align the first quarterly update to starts from 1st April. 	| TBC 	| TBC 	| Yes 	| TBC 	| December 2025 	|
...
|:------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:---------------------------------------------:|:----------------:|:-------------------:|
| [Individual Calculations](https://developer.service.hmrc.gov.uk/api-documentation/docs/api/service/individual-calculations-api) 	| **Claim outside of the amendment window** - enabling amendments to be made outside the amendment window, this is not likely to be actioned through software. 	| No 	| Yes 	| TBC  |
| [Individual Losses](https://developer.service.hmrc.gov.uk/api-documentation/docs/api/service/individual-losses-api) 	| **Carry back of losses** - enabling losses incurred in one tax year to be set off against profits made in previous years, subject to rules. 	| No 	| No 	| TBC 	|
| [Individual Calculations](https://developer.service.hmrc.gov.uk/api-documentation/docs/api/service/individual-calculations-api) 	| **Residence and remittance** - enabling software to support overseas customers with UK income. 	| No 	| Yes 	| TBC 	|
| [Individual Calculations](https://developer.service.hmrc.gov.uk/api-documentation/docs/api/service/individual-calculations-api) 	| **Partner income** - enabling software to support customers that have income from partnerships. 	| No 	| Yes 	| TBC 	|
| [Individual Calculations](https://developer.service.hmrc.gov.uk/api-documentation/docs/api/service/individual-calculations-api)	| **ITSA upload facility (end of year processing)** - enabling software to provide supporting attachments for ITSA submissions. 	| No 	| Yes 	| TBC 	|
| [Individual Calculations](https://developer.service.hmrc.gov.uk/api-documentation/docs/api/service/individual-calculations-api) 	| **Lloyd’s underwriters** - enabling software to support Lloyd’s underwriters. 	| No 	| Yes 	| TBC 	|
| [Individual Calculations](https://developer.service.hmrc.gov.uk/api-documentation/docs/api/service/individual-calculations-api) 	| **Averaging adjustments and special arrangements** - enabling software to support averaging adjustments. 	| No 	| Yes 	| TBC 	|
| [Individual Calculations](https://developer.service.hmrc.gov.uk/api-documentation/docs/api/service/individual-calculations-api) 	| **Member of Parliament** - enabling software to support Members of Parliament. 	| No 	| Yes 	| TBC 	|
| [Individual Calculations](https://developer.service.hmrc.gov.uk/api-documentation/docs/api/service/individual-calculations-api) 	| **Ministers of religion** - enabling software to support ministers of religion. 	| No 	| Yes 	| TBC 	|
| [Self-Employment Business](https://developer.service.hmrc.gov.uk/api-documentation/docs/api/service/self-employment-business-api) 	| **White space** - Support for submitting any other information as per SA return via software and ITSA submission service. 	| No 	| Yes 	| TBC 	|
